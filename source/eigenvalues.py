...
if (__name__ == '__main__'):
    ...
    smoother = pressuresolver.smoothers.Jacobi(operator,mu_relax=mu_relax,use_maximal_eigenvalue=True)
    ...
    m_eigen = np.zeros((ncells,ncells))
    m_smooth = np.zeros((ncells,ncells))
